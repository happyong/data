...
public class ConfigDaoService extends BaseDaoService
{
    ...
    private static final String insert_user = "insert into user_login (login_id, login_password, roles, status) values " + "(:name, :secure, :roles, :status) ";
    ...
    public List<UserLogin> getUsers()
    {
        ...
        for (Map<String, Object> result : results)
            list.add(new UserLogin().fromDbMap(UserLogin.class, result));
        return list;
    }

    private static final String select_user = "select login_id as name, login_password as secure, roles as roles, status as status " + "from user_login where ${cond} ";
}
