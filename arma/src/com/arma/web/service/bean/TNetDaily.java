...
public class TNetDaily extends BaseDaoBean
{
    ...
    {
        return (WebUtil.unull(code) + "|" + toTextS() + "|" + WebUtil.d2s(4, netTotal) + "|" + WebUtil.d2s(4, premium) + "|" + WebUtil.d2s(4, premium2) + "|"
                + WebUtil.d2s(4, premiumHigh5) + "|" + WebUtil.d2s(4, premiumLow5));
    }
