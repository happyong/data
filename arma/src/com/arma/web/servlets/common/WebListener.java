...
public class WebListener implements ServletContextListener
{
    ...
    private void startTimer()
    {
        ...
        if (ConfigHelper.common.show(PortalMenu.kms))
        {
            ...
            /*
             * map.put(QuartzHelper.METHOD, "refreshKeywords"); ssb = simpleSchedule().withIntervalInMinutes(2).repeatForever(); QuartzHelper.start(null, map, KmsTimerTask.class,
             * ssb); try { Thread.sleep(100L); } catch (Exception e) {}
             */
        }
    }
