...
public class InVarKM
{
    ...
    public static final String[] attrs_finance = new String[] { "id", "year", "gdp", "population", "agdp", "outlaysTotal", "outlaysCentral", "defenseTotal", "defenseCentral",
            "usaGdp", "usaPopulation", "usaAgdp", "usaOutlaysTotal", "usaDefenseTotal", "exchangeUsd" };
