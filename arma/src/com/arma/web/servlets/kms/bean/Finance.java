...
public class Finance
{
    ...
    {
        if (usd <= 0.0001 || d < 1) return -1001;
        return (d / usd);
    }
	
	private double ratio(double d, double base)
	{
	    if (d < 1 || base < 1) return -1001;
	    return (d * 100 / base);
	}
	...
	public String toText(int type)
	{
	    ...
	    if (type >= 0 && type < 100)
	    {
    	    ...
    	    sb.append(tfinance.getYear()).append("年，中国国防预算为").append(str(tfinance.getDefenseTotal())).append("亿元，").append(str(defenseTotalGrowth)).append("%，");
    	    sb.append("合").append(str(defenseTotalUsd)).append("亿美元，").append(str(defenseTotalUsdGrowth)).append("%，");
    	    sb.append("中央本级为").append(str(tfinance.getDefenseCentral())).append("亿元，").append(str(defenseCentralGrowth)).append("%。");
            sb.append(tfinance.getYear()).append("年，中国财政支出为").append(str(tfinance.getOutlaysTotal())).append("亿元，").append(str(outlaysTotalGrowth)).append("%，");
            sb.append("合").append(str(outlaysTotalUsd)).append("亿美元，").append(str(outlaysTotalUsdGrowth)).append("%，");
            sb.append("中央本级为").append(str(tfinance.getOutlaysCentral())).append("亿元，").append(str(outlaysCentralGrowth)).append("%，");
            sb.append("国防预算占比").append(str(defenseTotalOutlaysRatio)).append("%。");
            sb.append(tfinance.getYear()).append("年，中国GDP为").append(str(tfinance.getGdp())).append("亿元，").append(str(gdpGrowth)).append("%，");
            sb.append("合").append(str(gdpUsd)).append("亿美元，").append(str(gdpUsdGrowth)).append("%，");
            sb.append("财政支出相比为").append(str(outlaysTotalGdpRatio)).append("%，");
            sb.append("国防预算相比为").append(str(defenseTotalGdpRatio)).append("%。");
            sb.append(tfinance.getYear()).append("年，中国人均GDP为").append(tfinance.getAgdp()).append("元，").append(str(agdpGrowth)).append("%，");
            sb.append("合").append(agdpUsd).append("美元，").append(str(agdpUsdGrowth)).append("%。");
            sb.append(tfinance.getYear()).append("年，中国总人口为").append(str(tfinance.getPopulation())).append("万人，").append(str(4, populationGrowth)).append("%。");
            sb.append(tfinance.getYear()).append("年，人民币对美元平均汇率为").append(str(4, tfinance.getExchangeUsd())).append("，").append(str(exchangeUsdGrowth)).append("%。");
	    }
	    if (type == 0 || (type >= 100 && type < 200))
	    {
            ...
            sb.append(tfinance.getYear()).append("年，美国国防预算为").append(str(tfinance.getUsaDefenseTotal())).append("亿美元，").append(str(usaDefenseTotalGrowth)).append("%，");
            sb.append("中国相比为").append(str(defenseTotalUsRatio)).append("%。");
            sb.append(tfinance.getYear()).append("年，美国财政支出为").append(str(tfinance.getUsaOutlaysTotal())).append("亿美元，").append(str(usaOutlaysTotalGrowth)).append("%，");
            sb.append("中国相比为").append(str(outlaysTotalUsRatio)).append("%，");
            sb.append("国防预算占比").append(str(usaDefenseTotalOutlaysRatio)).append("%。");
            sb.append(tfinance.getYear()).append("年，美国GDP为").append(str(tfinance.getUsaGdp())).append("亿美元，").append(str(usaGdpGrowth)).append("%，");
            sb.append("中国相比为").append(str(gdpUsRatio)).append("%，");
            sb.append("财政支出相比为").append(str(usaOutlaysTotalGdpRatio)).append("%，");
            sb.append("国防预算相比为").append(str(usaDefenseTotalGdpRatio)).append("%。");
            sb.append(tfinance.getYear()).append("年，美国人均GDP为").append(tfinance.getUsaAgdp()).append("美元，").append(str(usaAgdpGrowth)).append("%，");
            sb.append("中国相比为").append(str(agdpUsRatio)).append("%。");
            sb.append(tfinance.getYear()).append("年，美国总人口为").append(str(tfinance.getUsaPopulation())).append("万人，").append(str(4, usaPopulationGrowth)).append("%，");
            sb.append("中国相比为").append(str(populationUsRatio)).append("%。");
	    }
	    return sb.toString();
	}
}
