...
public class PortalService extends AbstractBaseComponent
{
            ...
            String processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        if (!WebUtil.empty(request.getParameter("detid")))
            request.setAttribute("detid", request.getParameter("detid"));
    ...
    private void system(Map<String, Object> result, HttpServletRequest request)
    {
        ...
        if (user != null && user.isAdmin())
            result.put("users", UserHelper.users());
