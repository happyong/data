...
public class BeanMeta
{
    ...
    public BeanMeta(boolean cdata, String type, String field)
    {
        ...
        for (String str : arr)
            name3 += str.substring(0, 1).toUpperCase() + str.substring(1);
    ...
    public String copyit()
    {
        ...
        if ("String".equals(type) || "boolean".equals(type) || "int".equals(type))
            ...
            sb.append(BeanMain.blanks(2)).append("bean.set").append(name3).append("(").append(get()).append(" == null ? null : new Date(").append(get()).append(".getTime()));")
                    .append(WebUtil.line());
        else if (isList())
        {
            sb.append(BeanMain.blanks(2)).append("// ").append(name2).append(WebUtil.line());
            sb.append(BeanMain.blanks(2)).append("if (").append(name2).append(" != null) for (").append(list_cls).append(" ").append(list_node).append("0 : ").append(name2)
                    .append(") bean.add").append(list_cls).append("(").append(list_node).append("0.copyit());").append(WebUtil.line());
        }
        else
            // Bean
            sb.append(BeanMain.blanks(2)).append("bean.set").append(name3).append("(").append(get()).append(" == null ? null : ").append(get()).append(".copyit());")
                    .append(WebUtil.line());
        return sb.toString();
    }
    ...
    public String fromNode(boolean attr)
    {
        ...
        else if ("int".equals(type))
        {
            ...
            sb.append(BeanMain.blanks(2)).append("if (").append(name2).append("0 != -1) ").append(name2).append(" = ").append(name2).append("0;").append(WebUtil.line());
        }
        else if ("Date".equals(type))
        ...
        else if (isList())
        {
            ...
            sb.append(BeanMain.blanks(2)).append("List<Node> ").append(name2).append("0 = ParseUtil.nodes(\"").append(list_xpath).append("\", node);").append(WebUtil.line());
            sb.append(BeanMain.blanks(2)).append("if (").append(name2).append("0 != null) for (Node n : ").append(name2).append("0) add").append(list_cls).append("(new ")
                    .append(list_cls).append("().fromNode(n));").append(WebUtil.line());
        }
        else if ("Object".equals(type))
            sb.append(BeanMain.blanks(2)).append(name2).append(" = null;").append(WebUtil.line());
        else
        // Bean
        {
            sb.append(BeanMain.blanks(2)).append("List<Node> ").append(name2).append("0 = ParseUtil.nodes(\"").append(xpath).append("\", node);").append(WebUtil.line());
            sb.append(BeanMain.blanks(2)).append("if (").append(name2).append("0 != null) ").append(name2).append(" = new ").append(type).append("().fromNode(").append(name2)
                    .append("0.get(0));").append(WebUtil.line());
        }
        return sb.toString();
    }
    ...
    public String addParam()
    {
        ...
        sb.append(BeanMain.blanks(2)).append("if (this.").append(name2).append(" == null) this.").append(name2).append(" = new ArrayList<").append(list_cls).append(">();")
                .append(WebUtil.line());
    ...
    public String toXop()
    {
        ...
        if ("String".equals(type) || "boolean".equals(type) || "int".equals(type) || "Date".equals(type) || "Object".equals(type))
        {
            ...
            sb.append(BeanMain.blanks(2)).append(cond).append("xop.appendTag(").append(cdata ? "true" : "false").append(", \"").append(name).append("\", ").append(getNameValue())
                    .append(", null, null);").append(WebUtil.line());
        }
        else if ("List".equals(type))
        {
            sb.append(BeanMain.blanks(2)).append("xop.openTag(\"").append(name).append("\", null, null);").append(WebUtil.line());
            sb.append(BeanMain.blanks(2)).append("if (").append(name2).append(" != null) for (").append(list_cls).append(" ").append(list_node).append("0 : ").append(name2)
                    .append(") ").append(list_node).append("0.toXop(xop);").append(WebUtil.line());
    ...
    public String getset()
    {
        ...
        sb.append(BeanMain.blanks(1)).append("public void set").append(name3).append("(").append(getType0()).append(" ").append(name2).append(") {").append(WebUtil.line());
