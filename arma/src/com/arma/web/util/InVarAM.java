...
public class InVarAM 
{
	...
	public static final String[][] s_trading_close = {
		{"2014-01-01"}, {"2014-01-31", "2014-02-06"}, {"2014-04-05", "2014-04-07"}, {"2014-05-01", "2014-05-03"}, 
		{"2014-05-31", "2014-06-02"}, {"2014-09-06", "2014-09-08"}, {"2014-10-01", "2014-10-07"},
		{"2015-01-01", "2015-01-03"}, {"2015-02-18", "2015-02-24"}, {"2015-04-04", "2015-04-06"}, {"2015-05-01", "2015-05-03"}, 
		{"2015-06-20", "2015-06-22"}, {"2015-09-03", "2015-09-04"}, {"2015-09-26", "2015-09-27"}, {"2015-10-01", "2015-10-07"}
	};
	...
	/*
	// http://hq.sinajs.cn/rn=fgu87&list=s_sh000001,s_sz399001,s_sz399003,s_sz399006,int_hangseng,int_dji,int_nasdaq,int_sp500,int_ftse,int_nikkei
		var hq_str_s_sh000001="上证指数,5166.350,44.757,0.87,6256278,106016743.62601";
		var hq_str_s_sz399001="深证成指,18098.274,208.585,1.17,385071961,90484463";
		var hq_str_s_sz399003="成份Ｂ指,9093.353,2.165,0.02,173643,16565";
		var hq_str_s_sz399006="创业板指,3899.705,37.567,0.97,17990346,7721965";
		var hq_str_int_hangseng="恒生指数,27280.54,372.69,1.39";
		var hq_str_int_dji="道琼斯,17898.84,-140.53,-0.78";
		var hq_str_int_nasdaq="纳斯达克,5051.10,-31.41,-0.62";
		var hq_str_int_sp500="标普指数,2094.11,-14.75,-0.70";
		var hq_str_int_ftse="伦敦指数,6784.92,-61.82,-0.90";
		var hq_str_int_nikkei="日经指数,20407.08,24.11,0.12";

	// http://hq.sinajs.cn/rn=1318986550609&amp;list=hf_CL,hf_GC,hf_SI,hf_CAD,hf_ZSD,hf_S,hf_C,hf_W
		var hq_str_hf_CL="59.94,-1.3658,59.92,60.01,60.63,59.73,05:14:56,60.77,60.56,22453,0,0,2015-06-13,NYMEX原油";
		var hq_str_hf_GC="1180.8,0.0339,1180.3,1181.2,1183.7,1175.6,05:14:57,1180.4,1180.8,9938,0,0,2015-06-13,COMEX黄金";
		var hq_str_hf_SI="15.920,-0.2506,15.900,15.950,16.000,15.780,05:14:48,15.960,15.990,1612,0,0,2015-06-13,COMEX白银";
		var hq_str_hf_CAD="5915.00,0.5952,5913.50,5916.00,5916.00,5858.50,01:58:22,5880.00,5888.00,3770,0,0,2015-06-13,LME铜";
		var hq_str_hf_ZSD="2123.00,0.1888,2126.00,2129.50,2133.00,2095.00,03:00:00,2119.00,2126.00,1758,0,0,2015-06-13,LME锌";
		var hq_str_hf_S="940.00,0.0000,940.00,940.00,947.00,933.25,02:30:25,940.00,939.50,3277,0,0,2015-06-13,CBOT黄豆";
		var hq_str_hf_C="353.00,-0.9818,352.25,352.25,356.75,352.25,02:21:59,356.50,356.00,2299,0,0,2015-06-13,CBOT玉米";
		var hq_str_hf_W="503.75,-0.0992,504.00,505.75,510.75,500.50,02:30:28,504.25,503.75,2553,0,0,2015-06-13,CBOT小麦";

	// http://hq.sinajs.cn/rn=1318986628214&list=USDCNY,USDHKD,EURCNY,GBPCNY,USDJPY,EURUSD,GBPUSD
		var hq_str_USDCNY="16:30:09,6.2083,6.2084,6.2066,26,6.2067,6.2085,6.2059,6.2083,美元人民币";
		var hq_str_USDHKD="05:20:10,7.7524,7.7534,7.7524,21,7.7524,7.7537,7.7516,7.7524,美元港元";
		var hq_str_EURCNY="05:59:58,6.9902,6.9927,6.9809,792,6.9771,7.0063,6.9271,6.9902,欧元人民币";
		var hq_str_GBPCNY="05:59:58,9.6629,9.6654,9.6287,738,9.6299,9.6766,9.6028,9.6629,英镑人民币";
		var hq_str_USDJPY="05:02:25,123.41,123.43,123.49,7000,123.48,123.82,123.12,123.41,美元日元";
		var hq_str_EURUSD="05:03:08,1.1257,1.1265,1.1239,146,1.1238,1.1296,1.1150,1.1257,欧元美元";
		var hq_str_GBPUSD="05:03:31,1.5565,1.5568,1.5510,132,1.5511,1.5598,1.5466,1.5565,英镑美元";

	// http://hq.sinajs.cn/rn=fgu87&list=f_150265,sz150265,f_150266,sz150266,f_168201
		...
		var hq_str_f_150266="中融一带一路分级B,1.144,1.144,1.135,2015-06-12,9.87814";
		var hq_str_sz150266="一带B,1.235,1.236,1.234,1.244,1.216,1.234,1.235,294243738,361745107.354,581400,1.234,407972,1.233,502800,1.232,993365,1.231,879100,1.230,
			1222709,1.235,1059800,1.236,1193800,1.237,1933171,1.238,1485756,1.239,2015-06-12,15:05:37,00";
		var hq_str_f_168201="中融一带一路分级,1.074,1.074,1.07,2015-06-12,0.924475";
		0："中融一带一路分级B", 基金名称
		1："1.144″, 净值
		2："1.144″, 累计净值
		3："1.135″, 昨日净值
		...
		6："1.234″, 竞买价, 即"买一"报价
		7："1.235″, 竞卖价, 即"卖一"报价
		8："294243738″, 成交的股票数, 由于股票交易以一百股为基本单位, 通常把该值除以一百
		9："361745107.354″, 成交金额, 单位为"元", 通常以"万元"为成交金额的单位, 所以通常把该值除以一万
		10："581400″, "买一"申请581400股, 即5814手
		11："1.234″, "买一"报价
		(12, 13), (14, 15), (16,17), (18, 19)分别为"买二"至"买五"的情况
		20："1222709″, "卖一"申报1222709股, 即12227手
		21："1.235″, "卖一"报价
	...
	*/
	...
	public static final String s_fund_net_open_xml = s_fund_net_base + "xml.php/NetValue_Service.getNetValueOpen?rn={rn}&page=1&num={num}&"
			+ "sort=symbol&asc=1&ccode=&type2=2&type3=8";
	public static final String s_fund_net_open2_json = s_fund_net_base + "json.php/NetValue_Service.getNetValueOpen?rn={rn}&page=1&num={num}&"
			+ "sort=symbol&asc=1&ccode=&type2=2";
	public static final String s_fund_net_open2_xml = s_fund_net_base + "xml.php/NetValue_Service.getNetValueOpen?rn={rn}&page=1&num={num}&"
			+ "sort=symbol&asc=1&ccode=&type2=2";
	/*
		<item>
	...
	public static final String s_fund_net_cx_json = s_fund_net_base + "json.php/NetValue_Service.getNetValueCX?rn={rn}&page=1&num={num}&"
			+ "sort=symbol&asc=1&ccode=&type2=0";
	public static final String s_fund_net_cx_xml = s_fund_net_base + "xml.php/NetValue_Service.getNetValueCX?rn={rn}&page=1&num={num}&"
			+ "sort=symbol&asc=1&ccode=&type2=0";
